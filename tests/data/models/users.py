...
test_taker_1 = User(
    ...
    username="lena.lerner@slportal.ch",
    roles=[UserRole.FRONTEND, UserRole.TEST_TAKER]
)

test_taker_2 = User(
    id=uuid4(),
    username="lena.lerner@slportal.de",
    roles=[UserRole.FRONTEND, UserRole.TEST_TAKER]
)
...
test_scorer_1 = User(
    id=uuid4(),
    username="theodor.teacher@slportal.com",
    roles=[UserRole.FRONTEND, UserRole.TEST_SCORER]
)
