...
def test_insert_choice(db_session):
    bucket_data = insert_bucket_object(session=db_session, media_type=MediaType.IMAGE)
...
def test_update_choice(db_session: Session) -> None:
    bucket_data_1 = insert_bucket_object(session=db_session, media_type=MediaType.IMAGE, key_suffix="1")
    bucket_data_2 = insert_bucket_object(session=db_session, media_type=MediaType.IMAGE, key_suffix="2")
